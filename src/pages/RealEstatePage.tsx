...
const PHASES = [
    {
        ...
        description: "Before you pour the first slab, you need the right people. Our Recruiter Agent specializes in the 5 pillars of a Developer's office.",
        color: "blue",
        icon: Users,
        points: [
    ...
    },
    {
        ...
        description: "Launch day is mayhem. Thousands of leads, endless walk-ins, and lost data. Capture every opportunity.",
        color: "purple",
        icon: LayoutDashboard,
        points: [
            { title: "The Expo Force", desc: "Offline app captures visitor data & tags budget." },
            { title: "Database Resurrection", desc: "AI calls 50k cold leads in 24 hours." },
            { title: "Instant Brochure", desc: "WhatsApp sent before they leave the stall." }
        ],
    ...
    },
    {
        ...
        description: "Your Sales Managers are human. They get tired. Nexby does not. Omnichannel nurturing via WhatsApp, Email, and Voice.",
        color: "green",
        icon: MessageCircle,
        points: [
            { title: "Omnichannel Attack", desc: "Nurture via WhatsApp, Email, Voice." },
            { title: "WhatsApp Voice Call", desc: "Triggered instantly on interest." },
    ...
    },
    {
        ...
        description: "Post-sales anxiety is real. Deploy an AI Support Agent on your portal to answer status queries instantly.",
        color: "orange",
        icon: HardHat,
        points: [
            { title: "The Support Agent", desc: "Answers 'What is the status?' instantly." },
            { title: "Photo Updates", desc: "Sends latest site photos automatically." },
    ...
    },
    {
        ...
        description: "In Real Estate, a missed deadline is a massive penalty. Our Task Management System ensures nothing slips.",
        color: "red",
        icon: AlertTriangle,
        points: [
            { title: "Statutory Autopilot", desc: "Automated GST & RERA tasks." },
            { title: "One-Time Tasks", desc: "Track 'Land Title Search' to closure." },
            { title: "Escalation Matrix", desc: "Missed deadlines alert the Director." }
        ],
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="The only AI platform built by a family of builders, for builders. Automate hiring, sales, and operations for your real estate business." />
            </Helmet>
            ...
            <div className="min-h-screen bg-white pt-20">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed max-w-3xl mx-auto">
                                We don't just write code; we understand concrete, compliance, and closing ratios. The only AI platform built by a family of builders, for builders.
                            </p>
                    ...
                    <div className="max-w-4xl mx-auto px-6">
                        <div className="bg-slate-50 rounded-3xl p-8 md:p-12 border border-slate-200 relative overflow-hidden">
                            ...
                            <div className="prose prose-lg text-slate-700 relative z-10">
                                <p className="mb-6">
                                    I am a technologist by trade.
                                </p>
                                <p className="mb-6">
                                    For the last 12 years, I have worked as a Software Engineer, architecting enterprise-grade systems that solve complex business problems for global clients. My career has been defined by one rule: <strong>Technology must generate ROI, or it is useless.</strong>
                                </p>
                                <p className="mb-6">
                                    But I didn't choose to build solutions for Real Estate by accident.
                                </p>
                                <p className="mb-6">
                                    I come from a family of builders. I grew up watching the specific, chaotic reality of this industry—the pressure of launch days, the disconnect between sales and site, and the pain of adopting 'generic' software that wasn't built for the way you actually work.
                                </p>
                                <p className="mb-6">
                                    I founded Nexby to bridge that gap. I applied the rigorous standards of my engineering career to the specific problems I watched my family face.
                                </p>
                                <p className="font-medium text-slate-900">
                                    We don't build software to make you a 'tech company.' We build it to make you a more profitable Real Estate company.
                                </p>
                            </div>
                            ...
                            <div className="mt-8 flex items-center gap-4 relative z-10">
                                <div>
                                    ...
                                    <p className="text-slate-500 text-sm">Founder, Nexby AI Solutions</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <section className="py-20 bg-slate-100 overflow-hidden">
                    <div className="max-w-7xl mx-auto px-6 mb-10 flex justify-between items-end">
                        <div>
                            <h2 className="text-4xl font-bold text-slate-900 mb-4">The Project Lifecycle</h2>
                            <p className="text-xl text-slate-600">From hiring to handover, we have you covered.</p>
                        </div>
                ...
                <section className="py-20 bg-slate-900 text-white text-center">
                    <div className="max-w-4xl mx-auto px-6">
                        ...
                        <p className="text-xl text-slate-300 mb-8 leading-relaxed">
                            Most tech vendors invoice you for licenses even if the software sits unused. We are different. We sit with your team, we train them, and we ensure the system is actually delivering ROI. If it doesn't work, we don't deserve your business.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                                Let’s discuss your current project pipeline. No sales pitch, just a builder-to-builder conversation.
                            </p>
                        </div>
