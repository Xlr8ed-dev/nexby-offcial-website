...
const FAQS = [
    {
        ...
        answer: "The agent is designed to handle 70-80% of routine L1/L2 queries (password resets, access requests, FAQs). For complex issues requiring deep debugging or physical intervention, it gathers all necessary context (logs, screenshots) and intelligently routes the ticket to the right human engineer."
    },
    {
        question: "How long does it take to train on our data?",
        answer: "It's almost instant. We connect to your existing knowledge bases (Confluence, Notion, SharePoint) via API. The AI ingests and indexes your documentation in minutes. Fine-tuning for your specific tone and workflows typically takes 3-5 days."
    },
    {
        question: "Is our internal data secure?",
        answer: "Absolutely. We offer enterprise-grade security with role-based access control. We can also deploy the LLM within your private cloud (VPC) or on-premise, ensuring your sensitive data never leaves your environment."
    },
    {
        question: "Does it integrate with our existing ticketing system?",
        answer: "Yes. We have native bi-directional integrations with Jira Service Management, ServiceNow, Zendesk, and Freshdesk. The AI can create, update, resolve, and categorize tickets just like a human agent."
    },
    {
        question: "What if the AI gives the wrong answer?",
        answer: "We use RAG (Retrieval-Augmented Generation) which grounds the AI in your actual documentation. If the AI is not confident or cannot find the answer in your docs, it is programmed to say 'I don't know' and escalate to a human, rather than hallucinating an answer."
    }
];
...
const OperationsSolutionsPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>AI for Operations - Autonomous Support Agents | Nexby Solutions</title>
                <meta name="description" content="Automate 70% of L1 and L2 support requests instantly. Nexby’s Support AI Agent lives inside your ticketing system, learns from your knowledge base, and resolves issues without human intervention." />
                <meta name="keywords" content="AI support agents, IT automation, helpdesk AI, customer support automation, ITSM AI, operations automation, RAG for support" />

                {/* Open Graph Tags */}
                <meta property="og:title" content="AI for Operations - Autonomous Support Agents | Nexby" />
                <meta property="og:description" content="Automate 70% of L1 and L2 support requests instantly. Nexby’s Support AI Agent lives inside your ticketing system." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://nexby.ai/solutions/operations" />
            </Helmet>
            ...
            <div className="min-h-screen bg-white pt-20">
                ...
                <nav className="max-w-7xl mx-auto px-6 py-4" aria-label="Breadcrumb">
                    <ol className="flex items-center space-x-2 text-sm text-gray-600">
                        ...
                        <li className="before:content-['/'] before:mx-2 text-blue-600 font-medium">AI for Operations</li>
                    </ol>
                </nav>
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border-2 border-blue-300 rounded-full px-4 py-2 mb-6 shadow-lg">
                                ...
                                <span className="text-sm font-bold text-blue-900 uppercase tracking-wide">Solutions for Operations</span>
                            </div>
                            ...
                            <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
                                Automate 70% of L1 and L2 support requests instantly. Nexby’s Support AI Agent lives inside your ticketing system, learns from your knowledge base, and resolves issues without human intervention.
                            </p>
                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <div className="prose prose-lg max-w-none text-center">
                            <p className="text-lg text-gray-700 leading-relaxed mb-4">
                                Modern support teams are drowning in repetition. Your most expensive engineers and support staff are wasting hours on "password resets," "status checks," and "policy questions." This isn't just inefficient; it's a morale killer.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Nexby believes that support shouldn't be a queue—it should be an answer. We deploy <span className="font-bold text-blue-700">cognitive agents</span> that act as the first line of defense, absorbing the noise so your humans can focus on the complex, high-value problems that actually require empathy and judgment.
                            </p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <span className="font-bold text-gray-900">Instant Deflection:</span>
                                            <span className="text-gray-600"> Intercepts incoming queries via chat, email, or Slack. Resolves routine L1/L2 issues in seconds.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Bot className="text-blue-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Dynamic Diagnostics:</span>
                                            <span className="text-gray-600"> Asks clarifying questions to diagnose the root cause before offering a solution, mimicking a skilled analyst.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-indigo-200 hover:border-indigo-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        <Database className="text-indigo-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Unified Intelligence:</span>
                                            <span className="text-gray-600"> Connects directly to Confluence, Notion, SharePoint, or Google Drive.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <MessageSquare className="text-indigo-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Contextual Answers:</span>
                                            <span className="text-gray-600"> Reads documents, extracts relevant paragraphs, and summarizes answers in plain language. No more PDF links.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-cyan-200 hover:border-cyan-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <p className="text-gray-600 mb-4">
                                    A support agent that can't fix things is just a glorified search bar. Nexby takes action.
                                </p>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        <Workflow className="text-cyan-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Autonomous Execution:</span>
                                            <span className="text-gray-600"> Password resets, license provisioning, and ticket categorization happen automatically via API hooks.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Users className="text-cyan-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Smart Handoff:</span>
                                            <span className="text-gray-600"> Creates tickets, categorizes them, and summarizes conversations for human agents if it can't solve the issue.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16">
                            ...
                            <p className="text-xl text-blue-300">
                                Whether you are running an internal IT helpdesk or a customer support center, uptime and security are non-negotiable.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-white/5 backdrop-blur-sm border-2 border-blue-500/30 rounded-2xl p-8 hover:bg-white/10 hover:border-blue-500/50 transition-all">
                                ...
                                <p className="text-gray-300">
                                    The AI respects your existing permission structures. It won't reveal sensitive HR policy data to a junior developer.
                                </p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border-2 border-cyan-500/30 rounded-2xl p-8 hover:bg-white/10 hover:border-cyan-500/50 transition-all">
                                ...
                                <p className="text-gray-300">
                                    Every automated action and conversation is logged, ensuring full visibility and accountability for compliance audits.
                                </p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border-2 border-indigo-500/30 rounded-2xl p-8 hover:bg-white/10 hover:border-indigo-500/50 transition-all">
                                ...
                                <p className="text-gray-300">
                                    Your operations center never goes offline, ensuring continuity across global shifts.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    "I can't connect to the VPN." "I need a Jira license." Nexby handles these thousands of monthly requests automatically, freeing up your IT staff to work on infrastructure and security projects.
                                </p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-indigo-50 to-purple-50 rounded-3xl p-8 border-2 border-indigo-200 hover:border-indigo-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    Reduce your Average Handle Time (AHT) dramatically. The agent handles order status inquiries, refund eligibility checks, and basic troubleshooting, leaving your agents free to handle VIP escalations.
                                </p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-cyan-50 to-teal-50 rounded-3xl p-8 border-2 border-cyan-200 hover:border-cyan-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    "What is the maternity leave policy?" "How do I claim LTA?" Automate the repetitive employee service queries while maintaining a private, secure environment for sensitive HR data.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="bg-white rounded-2xl p-6 border-2 border-blue-200 hover:border-blue-400 hover:shadow-lg transition-all">
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 className="text-lg font-bold text-gray-900">Ticketing & ITSM</h3>
                                </div>
                            ...
                            <div className="bg-white rounded-2xl p-6 border-2 border-indigo-200 hover:border-indigo-400 hover:shadow-lg transition-all">
                                <div className="flex items-center gap-3 mb-3">
                                    ...
                                    <h3 className="text-lg font-bold text-gray-900">Knowledge Bases</h3>
                                </div>
                                <p className="text-gray-600 text-sm">
