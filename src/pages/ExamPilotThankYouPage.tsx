        ...
        <div className="max-w-lg w-full bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 text-center relative overflow-hidden">
          ...
          <p className="text-gray-600 mb-8 leading-relaxed">
            ...
            <span className="font-semibold text-purple-700">
              Nexby Digital Examination Center
            </span>
            . Our academic solutions team will review your institution's profile
            and contact the Registrar's office within 24 hours to discuss the
            pilot parameters.
          </p>
