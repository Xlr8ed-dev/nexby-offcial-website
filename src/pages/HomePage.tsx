...
//   const scale = useTransform(scrollYProgress, [0, 0.4], [8, 1]);
//   const y = useTransform(scrollYProgress, [0, 0.4], [0, -50]);
...
//   useEffect(() => {
//     // Ensure first paint is ALWAYS crisp
...
//           transition={{ duration: 0.3 }}
//           style={{
//             scale: mounted ? scale : 1, // 👈 CRITICAL LINE
//             y: mounted ? y : 0,
//           }}
//           className="z-20 text-[10rem] sm:text-[14rem] md:text-[18rem]
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-4xl md:text-6xl font-bold text-gray-900 leading-tight">
              We've helped 300+ businesses design and deploy AI in the real
              world.
            </h2>
            <p className="text-xl text-gray-500 leading-relaxed max-w-xl">
              From exhibitions and sales funnels to recruitment desks and
              operations command centers — Nexby AI ships systems that stick,
              not experiments that die in slides.
            </p>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-emerald-100 p-8 rounded-3xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border-2 border-green-200 h-full flex flex-col justify-center">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Across India, GCC and global markets. Delivering scalable AI
                architectures.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-cyan-100 p-8 rounded-3xl hover:shadow-2xl hover:scale-105 transition-all duration-300 border-2 border-blue-200 h-full flex flex-col justify-center">
              ...
              <p className="text-gray-700 text-sm leading-relaxed">
                Most clients recover their AI investment inside two quarters
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Industry-specific AI infrastructure designed to solve real-world
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Deploy autonomous AI Sales Agents that qualify, nurture, and close
              leads across voice and text channels. Zero latency, infinite
              scale.
            </p>
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">
                  Omnichannel deployment (Voice, WhatsApp, Email, Web)
                </span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="text-purple-600" size={18} />
                <span className="text-gray-700">
                  Dynamic conversation flow with objection handling
                </span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="text-purple-600" size={18} />
                <span className="text-gray-700">
                  CRM integration with instant lead sync
                </span>
              </div>
            </div>
            <a
          ...
          >
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              Hire the top 1% automatically with AI-powered screening, adaptive
              interviews, and proctored evaluations. 90% reduction in
              time-to-hire.
            </p>
            <div className="space-y-3 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span className="text-gray-700">
                  Adaptive voice & video interviews with technical vivas
                </span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="text-blue-600" size={18} />
                <span className="text-gray-700">
                  Military-grade proctoring (lip-sync, tab monitoring)
                </span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="text-blue-600" size={18} />
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-3xl p-8 border-2 border-blue-200 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Autonomous hiring platform that screens, interviews, and ranks
              talent at infinite scale. 100% data-driven, 0% bias.
            </p>
          ...
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 border-2 border-purple-200 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              Enterprise voice agents that handle qualification calls,
              objections, and appointment booking with human-level nuance.
            </p>
            <div className="space-y-2 mb-6">
              <div className="flex items-center gap-2 text-sm">
          ...
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 border-2 border-green-200 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              The operating system for trade shows. Offline-first mobile app &
              powerful analytics dashboard for exhibitions.
            </p>
            <div className="space-y-2 mb-6">
              <div className="flex items-center gap-2 text-sm">
                <Lock className="text-green-600" size={16} />
                <span className="text-gray-600">
                  Military-grade OCR scanning
                </span>
              </div>
              <div className="flex items-center gap-2 text-sm">
    ...
    <section className="py-24 bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Built on cutting-edge AI infrastructure with flexible deployment
            options
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-12">
          <div className="bg-white rounded-2xl p-8 border-2 border-purple-200 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600">
              Rapid scaling on secure, global infrastructure with 99.9% uptime
              SLA
            </p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-8 border-2 border-blue-200 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600">
              Deploy LLM within your private infrastructure. Your data never
          ...
          <div className="bg-white rounded-2xl p-8 border-2 border-green-200 hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600">
              Built to adhere to GDPR, TCPA, HIPAA and regional data sovereignty
              standards
            </p>
          </div>
        </div>
    ...
    <section className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            We don't build experiments. We ship production-grade AI systems that
            stick.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-2xl p-8 border-2 border-purple-200">
            ...
            <p className="text-gray-600">
              Across India, GCC, and global markets with scalable AI
              architectures
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl p-8 border-2 border-blue-200">
            ...
            <p className="text-gray-600">
              Most clients recover AI investment inside two quarters through
              efficiency gains
            </p>
          </div>
