                ...
                <div className="max-w-2xl mx-auto px-6 py-20 text-center">
                    ...
                    <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200 mb-10">
                        ...
                        <p className="text-lg text-slate-700 leading-relaxed mb-4">
                            "We have received your audit request. Our system is currently assessing your profile fit."
                        </p>
                        <p className="text-slate-600 mb-6">
                            A forensic specialist will review your volume and use-case details. If your organization qualifies for the <span className="font-semibold text-slate-900">Free L1 Forensic Audit</span>, you will receive a calendar invitation within 24 hours.
                        </p>
