...
const ContactPage = () => {
    ...
    const officeAddress = "15, Khatau Building, 44 Bank Street, Mumbai - 400001, India";
    const mapsEmbedUrl = "https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3774.0772289959804!2d72.83123!3d18.93279!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3be7d1c0c4d5c5b5%3A0x3b3c3f3f3c3c3c3c!2s44%20Bank%20St%2C%20Fort%2C%20Mumbai%2C%20Maharashtra%20400001!5e0!3m2!1sen!2sin!4v1234567890123!5m2!1sen!2sin";

    return (
        <>
            <Helmet>
                <title>Contact Us - Nexby AI Solutions | Get in Touch with Our AI Experts</title>
                <meta name="description" content="Contact Nexby AI Solutions for AI-powered recruitment, sales, and exhibition management solutions. Reach out via email, phone, or visit our Mumbai office." />
                <meta name="keywords" content="contact nexby, AI solutions contact, Mumbai AI company, AI consultation, business automation support" />

                {/* Open Graph Tags */}
                <meta property="og:title" content="Contact Us - Nexby AI Solutions" />
                <meta property="og:description" content="Get in touch with Nexby AI Solutions for cutting-edge AI automation solutions." />
                ...
                <section className="bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 py-16">
                    <div className="max-w-7xl mx-auto px-6 text-center">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                            Ready to transform your business with AI? Reach out to us and let's discuss how we can help you automate and scale.
                        </p>
                    </div>
                </section>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-purple-100 hover:border-purple-300 transition-all hover:shadow-xl">
                                ...
                                <a href="mailto:hello@nexby.ai" className="text-purple-600 font-medium hover:text-purple-800 transition-colors block mb-1">
                                    hello@nexby.ai
                                </a>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-blue-100 hover:border-blue-300 transition-all hover:shadow-xl">
                                ...
                                <p className="text-sm text-gray-600 mb-3">Mon-Fri from 9am to 6pm IST</p>
                                <a href="tel:+919892048816" className="text-blue-600 font-medium hover:text-blue-800 transition-colors text-lg">
                                    +91 98920 48816
                                </a>
                            </div>
                            ...
                            <div className="bg-white rounded-2xl shadow-lg p-6 border-2 border-green-100 hover:border-green-300 transition-all hover:shadow-xl">
                                ...
                                <p className="text-sm text-gray-600 mb-3">Get instant responses</p>
                                <a
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div>
                                ...
                                <ContactForm showDescription={false} formId="contact_page_form" />
                            </div>
                                ...
                                <div>
                                    ...
                                    <div className="bg-gradient-to-br from-white via-purple-50/30 to-pink-50/30 rounded-2xl border-2 border-purple-200 p-6 mb-6">
                                        <div className="flex items-start gap-4 mb-4">
                                            ...
                                            <div>
                                                <h3 className="font-bold text-gray-900 mb-2">Nexby AI Solutions Private Limited</h3>
                                                <address className="text-gray-700 not-italic leading-relaxed">
                                                    15, Khatau Building, 44 Bank Street<br />
                    ...
                    <div className="max-w-4xl mx-auto px-6">
                        ...
                        <div className="space-y-6">
                            <div className="bg-white rounded-xl p-6 shadow-sm">
                                <h3 className="font-bold text-lg text-gray-900 mb-2">How quickly can I expect a response?</h3>
                                <p className="text-gray-600">Our team typically responds within 24 hours during business days. For urgent inquiries, please call us directly.</p>
                            </div>
                            <div className="bg-white rounded-xl p-6 shadow-sm">
                                <h3 className="font-bold text-lg text-gray-900 mb-2">Do you offer free consultations?</h3>
                                <p className="text-gray-600">Yes! We offer a complimentary initial consultation to understand your needs and determine if our AI solutions are the right fit for your business.</p>
                            </div>
                            <div className="bg-white rounded-xl p-6 shadow-sm">
                                <h3 className="font-bold text-lg text-gray-900 mb-2">What information should I prepare before contacting you?</h3>
                                <p className="text-gray-600">It's helpful to have a clear understanding of your current business challenges, team size, and specific areas where you'd like to implement AI automation.</p>
                            </div>
                        </div>
                    </div>
                </section>
