          ...
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="flex-1">
              ...
              <p className="text-lg text-slate-300 mb-8 max-w-xl leading-relaxed">
                Transform your Pre-Bid ecosystem from a chaotic email inbox into
                a structured, AI-driven command center. Nexby automates query
                ingestion, drafts legally consistent replies, and deflects
                redundant vendor questions instantly.
              </p>
              ...
              <div className="relative rounded-2xl overflow-hidden bg-slate-800 border border-slate-700 shadow-2xl group min-h-[400px]">
                ...
                <div className="absolute top-8 left-8 bottom-8 w-1/3 bg-white rounded-xl shadow-lg transform -rotate-3 transition-transform duration-500 hover:rotate-0 z-10 p-4 border border-slate-200">
                  ...
                  <div className="absolute bottom-4 left-0 right-0 text-center">
                    <div className="inline-block px-2 py-1 bg-green-100 text-green-700 text-[8px] font-bold rounded-full">
                      QUERY DEFLECTED
                    </div>
                  </div>
                </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="p-3 bg-slate-800 rounded border border-slate-700">
                      ...
                      <div className="text-[10px] text-slate-500 italic">
                        "Matches 2023 Expressway Tender Response..."
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-6">
              Why Manual Pre-Bid Management is Failing.
            </h2>
            <p className="text-lg text-slate-600 leading-relaxed">
              For a nodal agency handling infrastructure projects, the "Pre-Bid"
              phase is the biggest bottleneck.
            </p>
          </div>
          ...
          <div className="mt-12 p-6 bg-slate-900 rounded-xl text-white flex flex-col md:flex-row items-center justify-between gap-6">
            <div>
              ...
              <p className="text-slate-400 text-sm">
                Eliminates these inefficiencies by enforcing structure and
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
              Core Capabilities: Ministries / PSUs.
            </h2>
          </div>
          ...
          <div className="space-y-12">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="flex-1">
                  ...
                  <h3 className="text-2xl font-bold text-white mb-4">
                    Unified Ingestion & Auto-Formatting
                  </h3>
                  <h4 className="text-lg text-blue-400 mb-4">
                    Stop Copy-Pasting from Emails.
                  </h4>
                  <p className="text-slate-400 leading-relaxed mb-6">
                    Nexby acts as a structured gateway. Whether a vendor sends
                    an email, uploads Excel, or uses voice, our AI parses it
                    into the mandatory{" "}
                    <strong>
                      Standard Query Format (Clause No | Page No | Query |
                      Response)
                    </strong>
                    .
                  </p>
                  <ul className="space-y-2 text-sm text-slate-500">
                    <li className="flex items-center gap-2">
                      ...
                      Auto-Deduplication of identical queries
                    </li>
                    <li className="flex items-center gap-2">
                      <CheckCircle size={14} className="text-green-500" />{" "}
                      Multi-channel ingestion (Email, Portal, Voice)
                    </li>
                  </ul>
                </div>
                <div className="flex-1 w-full bg-slate-950 rounded-xl p-6 border border-slate-700 font-mono text-xs text-slate-400">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <span className="text-blue-400">Found:</span> 5 distinct
                      queries.
                    </div>
                    <div>
                      <span className="text-purple-400">Action:</span>{" "}
                      Reformatted to Table 4.1.
                    </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="rounded-3xl bg-slate-900 border border-slate-800 p-8 hover:border-blue-500/30 transition-all">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">
                  The "Historical Brain" (RAG)
                </h3>
                <p className="text-slate-400 mb-4">
                  Your department has answered thousands of queries. Why start
                  from scratch?
                </p>
                <ul className="space-y-4 text-sm text-slate-500">
                  <li className="bg-slate-950 p-4 rounded-lg border border-slate-800">
                    ...
                    "In the 2023 Expressway Tender, we rejected a similar
                    request regarding Turnover."
                  </li>
                  <li className="bg-slate-950 p-4 rounded-lg border border-slate-800">
                    <strong className="text-white block mb-1">
                      Draft Auto-Generation
                    </strong>
                    AI drafts legally sound responses citing specific SBD
                    clauses.
                  </li>
                </ul>
              </div>
              ...
              <div className="rounded-3xl bg-slate-900 border border-slate-800 p-8 hover:border-teal-500/30 transition-all">
                ...
                <div className="bg-red-900/10 border border-red-500/20 p-4 rounded-lg">
                  ...
                  <p className="text-xs text-red-300/80">
                    "Warning: This draft reply contradicts Ministry Circular
                    dated 12/05/2024 regarding Bid Security."
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16">
            ...
            <p className="text-lg text-slate-600">
              Empower vendors to self-service, reducing officer load.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-slate-600 mb-6">
                "Talk to the RFP". Vendors can upload the 500-page document and
                ask questions.
              </p>
              <div className="bg-slate-50 border border-slate-200 rounded-xl p-6">
                ...
                <div>
                  <p className="text-xs font-bold text-slate-400 uppercase mb-1">
                    AI Answer (Strict Source-of-Truth)
                  </p>
                  <p className="text-slate-700 text-sm">
                    "According to Clause 12.5, penalty is 0.5% per week of
                    delay."
                  </p>
                </div>
              </div>
                ...
                <li className="flex gap-3">
                  ...
                  <div>
                    <strong className="block text-slate-900">
                      Voice-to-Formal Query
                    </strong>
                    <p className="text-sm text-slate-500">
                      Site engineers can dictate queries via mobile app.
                    </p>
                  </div>
                </li>
                <li className="flex gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">
                      Transcribed and reformatted into professional tender
                      language.
                    </p>
                  </div>
                </li>
      ...
      <section className="py-20 bg-slate-50 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <h2 className="text-2xl font-bold text-slate-900 mb-12">
            Technical Architecture (Sovereign & Secure)
          </h2>
          <div className="grid md:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-sm text-slate-500">
                OCR for scanned PDFs, supporting multi-column government gazette
                layouts.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-sm text-slate-500">
                Full Data Localization. Containerized for State Data Center
                (SDC) / NIC Cloud deployment.
              </p>
            </div>
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-sm text-slate-500">
                Fully compliant with IT Act 2000 & DPDP Act 2023 guidelines for
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
              ...
              <p className="text-sm text-slate-500">
                Native APIs for GeM, CPP Portal, and e-Office.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="bg-slate-900 rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="inline-block px-3 py-1 bg-white/10 rounded-full text-xs font-bold mb-6">
                CASE STUDY: HIGHWAY AUTHORITY
              </div>
              <h2 className="text-3xl font-bold mb-8">
                Accelerating National Infrastructure.
              </h2>
              ...
              <div className="grid md:grid-cols-3 gap-8 border-t border-slate-800 pt-8">
                <div>
                  ...
                  <p className="mt-2 text-xs text-slate-500">
                    AI parsed & deduplicated emails into 450 unique line items.
                  </p>
                </div>
                <div>
                  <div className="text-4xl font-bold text-blue-400 mb-2">
                  ...
                  <p className="mt-2 text-xs text-slate-500">
                    Vendor Chatbot answered trivial questions automatically.
                  </p>
                </div>
                <div>
          ...
          <div className="flex flex-col md:flex-row gap-16 items-center">
            <div className="flex-1 text-white">
              <h2 className="text-3xl md:text-5xl font-bold mb-6">
                Modernize Your Pre-Bid Ecosystem.
              </h2>
              <p className="text-lg text-slate-400 mb-8">
                Move from "Email Chaos" to "AI Command." Request a technical
                demonstration for your Ministry.
              </p>
            </div>
