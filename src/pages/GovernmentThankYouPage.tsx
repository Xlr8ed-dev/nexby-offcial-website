      ...
      <main className="flex-grow pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-slate-600 mb-12 max-w-2xl mx-auto leading-relaxed">
            ...
            <strong>Sovereign AI Call Assistant</strong> documentation. Our
            Government Relations team is currently verifying your credentials.
          </p>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-200 max-w-xl mx-auto text-left mb-12">
            ...
            <ol className="list-decimal list-inside space-y-3 text-slate-600">
              <li>
                <strong>Credential Verification:</strong> 24-48 Hours.
              </li>
              <li>
                <strong>Secure Link:</strong> You will receive a one-time secure
                link to the technical whitepaper on your official email.
              </li>
              <li>
                <strong>Pilot Discussion:</strong> A senior solutions architect
                will reach out to schedule a preliminary briefing.
              </li>
            </ol>
          </div>
