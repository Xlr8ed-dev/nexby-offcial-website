...
const FAQS = [
    {
        ...
        answer: "No. Nexby employs military-grade proctoring. We monitor tab switching, detect secondary voices, analyze eye movement patterns, and flag suspicious behavior in real-time. If a candidate uses ChatGPT or a proxy, they are instantly flagged."
    },
    {
        question: "How technical can the interviews get?",
        answer: "Extremely. Our AI can conduct deep-dive technical vivas, ask candidates to write and explain code, and debug scenarios in real-time. It goes far beyond multiple-choice questions to assess actual problem-solving ability."
    },
    {
        question: "Will this replace my human recruiters?",
        answer: "No, it supercharges them. Nexby handles the repetitive L1 screening—the thousands of resumes and initial phone screens—so your recruiters can focus purely on closing the top 5% of candidates."
    },
    {
        question: "Does it integrate with our ATS (Greenhouse, Lever, etc.)?",
        answer: "Yes. We push qualified candidates and their interview transcripts directly into your existing ATS. You don't need to change your workflow; we just make it faster."
    },
    {
        question: "Is the AI evaluation fair and unbiased?",
        answer: "Absolutely. The AI evaluates purely based on the candidate's responses and the job criteria. It is blind to gender, ethnicity, accent, and background, ensuring a 100% meritocratic screening process."
    }
];
...
const HRSolutionsPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>AI for Recruitment - Autonomous Hiring Agents | Nexby Solutions</title>
                <meta name="description" content="Hire the top 1% automatically. Nexby's Recruiter AI Agent screens, interviews, and ranks talent with human-level nuance and machine-level speed." />
                <meta name="keywords" content="AI recruitment, autonomous hiring, AI interviewer, resume screening AI, automated talent intelligence, proctored interviews, technical screening AI" />

                {/* Open Graph Tags */}
                <meta property="og:title" content="AI for Recruitment - Autonomous Hiring Agents | Nexby" />
                <meta property="og:description" content="Hire the top 1% automatically. Screen, interview, and rank talent with human-level nuance." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://nexby.ai/solutions/recruitment" />
            ...
            <div className="min-h-screen bg-white pt-20">
                ...
                <nav className="max-w-7xl mx-auto px-6 py-4" aria-label="Breadcrumb">
                    <ol className="flex items-center space-x-2 text-sm text-gray-600">
                        ...
                        <li className="before:content-['/'] before:mx-2 text-purple-600 font-medium">AI for Recruitment</li>
                    </ol>
                </nav>
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border-2 border-purple-300 rounded-full px-4 py-2 mb-6 shadow-lg">
                                ...
                                <span className="text-sm font-bold text-purple-900 uppercase tracking-wide">Solutions for Recruitment</span>
                            </div>
                            ...
                            <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
                                From job description to final interview in minutes, not months. Nexby’s Recruiter AI Agent screens, interviews, and ranks <span className="font-bold text-purple-700">your existing talent pipeline</span> with human-level nuance and machine-level speed.
                            </p>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
                            ...
                            <div className="flex items-center gap-3 group cursor-default">
                                ...
                                <span className="font-semibold text-white text-lg">LinkedIn</span>
                            </div>
                            ...
                            <div className="flex items-center gap-3 group cursor-default">
                                ...
                                <span className="font-semibold text-white text-lg">Career Page</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <div className="prose prose-lg max-w-none">
                            <p className="text-lg text-gray-700 leading-relaxed mb-4">
                                <span className="font-bold text-purple-700">Traditional hiring is broken.</span> It’s a 140-hour marathon of resume scanning, scheduling tag, and repetitive screening calls that results in a single hire. We reimagined this process as a 13-minute sprint.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed">
                                Nexby isn't just an ATS filter; it is an <span className="font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Automated Talent Intelligence (ATI)</span> system. <span className="font-bold text-gray-900">We are not a staffing agency.</span> We don't source candidates; we scientifically filter the ones you already have. We conduct adaptive, proctored interviews that assess competency, intent, and cultural fit before your team ever picks up the phone.
                            </p>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-purple-200 hover:border-purple-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <span className="font-bold text-gray-900">Adaptive Interviews:</span>
                                            <span className="text-gray-600"> Unlike static forms, our AI adapts to the candidate’s answers. If a candidate claims expert-level coding skills, the AI digs deeper with complex technical scenarios.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Globe className="text-purple-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Multi-Lingual Fluency:</span>
                                            <span className="text-gray-600"> Screen candidates in over 30 languages instantly, breaking down global hiring barriers.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <TrendingUp className="text-purple-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Linear & Non-Linear Paths:</span>
                                            <span className="text-gray-600"> Whether it’s a structured behavioral round or an open-ended case study, the agent manages the flow perfectly.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <span className="font-bold text-gray-900">Contextual Matching:</span>
                                            <span className="text-gray-600"> We go beyond "Ctrl+F." The system analyzes resumes against the core DNA of the role, rejecting unfit profiles instantly and ranking the rest by relevance.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Sparkles className="text-blue-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Universal Smart Link Integration:</span>
                                            <span className="text-gray-600"> Paste your Nexby Smart Link on LinkedIn, Naukri, Indeed, or your Career Page. Candidates click, get screened, and you get the results.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-green-200 hover:border-green-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <p className="text-gray-600 mb-4">
                                    In a world of digital proxies and lip-sync frauds, Nexby is your shield.
                                </p>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        <Lock className="text-green-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Fake Candidate Detection:</span>
                                            <span className="text-gray-600"> Our proprietary anti-cheating layer flags suspicious audio patterns, lip-sync mismatches, and tab-switching during assessments.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckCircle className="text-green-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Proctored Evaluations:</span>
                                            <span className="text-gray-600"> Ensure the code written or the answer given is 100% authentic.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                ...
                <section className="py-20 bg-slate-900 text-white">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <p className="text-lg text-gray-300 leading-relaxed mb-12 max-w-4xl mx-auto text-center">
                            Whether you are hiring 50 specialists or 5,000 graduates, Nexby’s architecture handles the load without cracking.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            <div className="bg-white/5 backdrop-blur-sm border-2 border-purple-500/30 rounded-2xl p-8 hover:bg-white/10 hover:border-purple-500/50 transition-all">
                                ...
                                <p className="text-gray-300">
                                    Our algorithms are tuned to evaluate skill and merit only, removing unconscious human bias from the L1 screening layer.
                                </p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border-2 border-pink-500/30 rounded-2xl p-8 hover:bg-white/10 hover:border-pink-500/50 transition-all">
                                ...
                                <p className="text-gray-300">
                                    Candidate data is stored with strict adherence to GDPR and regional privacy laws.
                                </p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border-2 border-blue-500/30 rounded-2xl p-8 hover:bg-white/10 hover:border-blue-500/50 transition-all">
                                ...
                                <p className="text-gray-300">
                                    Revisit interview recordings, transcripts, and scores anytime. Your talent pool remains an active asset, not a dead database.
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 border-2 border-purple-200 hover:border-purple-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    Screening 10,000 graduates? It used to take a month. Nexby does it in an afternoon. Filter by aptitude, conduct mass proctored tests, and present the top 50 to your hiring managers.
                                </p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    For IT Services and Engineering, resume keywords can be misleading. Our AI conducts rigorous technical vivas, asking code-specific logic questions to separate coders from copy-pasters.
                                </p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 border-2 border-green-200 hover:border-green-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    Hiring a sales team in Japan or Brazil? You don't need local recruiters immediately. Our multi-lingual agent conducts the first rounds in native languages, ensuring you only fly in for the final handshake.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-8 hover:bg-white/10 transition-all text-center">
                                ...
                                <p className="text-lg text-purple-300 font-medium mb-4 uppercase tracking-wider">Reduction in Time-to-Hire</p>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-blue-500/30 rounded-2xl p-8 hover:bg-white/10 transition-all text-center">
                                ...
                                <p className="text-lg text-blue-300 font-medium mb-4 uppercase tracking-wider">Reduction in Hiring Costs</p>
                                <p className="text-gray-400">
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-green-500/30 rounded-2xl p-8 hover:bg-white/10 transition-all text-center">
                                ...
                                <p className="text-lg text-green-300 font-medium mb-4 uppercase tracking-wider">Bad Hires due to Fraud</p>
                                <p className="text-gray-400">
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                                Integrate Nexby into your job posts today and identify your top 3 candidates automatically.
                            </p>
                        </div>
