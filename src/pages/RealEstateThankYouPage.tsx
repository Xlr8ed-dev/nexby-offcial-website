...
const RealEstateThankYouPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>Thank You - Nexby Real Estate Solutions</title>
            ...
            <div className="min-h-screen bg-white pt-20 flex items-center justify-center">
                <div className="max-w-2xl mx-auto px-6 py-20 text-center">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        ...
                        <Link
                            to="/solutions/industry/real-estate"
                        ...
                        >
                            Back to Real Estate Page <ArrowRight size={18} />
                        </Link>
                    </div>
                </div>
            </div>
...
export default RealEstateThankYouPage;
