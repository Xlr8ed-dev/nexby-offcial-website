...
const FAQS = [
    {
        ...
        answer: "Our AI is trained on top-tier sales methodologies (Sandler, SPIN). It acknowledges the objection, empathizes, and pivots to value, just like a senior SDR. It doesn't just read a script; it negotiates."
    },
    {
        question: "Can it book meetings directly on my calendar?",
        answer: "Yes. The AI integrates with Google Calendar, Outlook, and Calendly. It negotiates a time with the lead and sends the invite instantly."
    },
    {
        question: "Does it sound robotic?",
        answer: "Not at all. We use ultra-low latency voice synthesis with natural pauses, filler words ('um', 'uh'), and intonation changes. Most leads don't realize they are talking to an AI until the end."
    },
    {
        question: "What happens if the AI doesn't know the answer?",
        answer: "It gracefully handles the unknown by noting the question and promising a follow-up from a human specialist, or it can transfer the call to a human agent in real-time if you choose."
    },
    {
        question: "Is it compliant with TCPA and other regulations?",
        answer: "Yes. Nexby is built with compliance first. We support DNC list checking, call recording consent, and permissible calling hours configuration."
    }
];
...
const SalesSolutionsPage = () => {
    ...
    return (
        <>
            <Helmet>
                <title>AI for Sales - Autonomous Sales Agents | Nexby Solutions</title>
                <meta name="description" content="Deploy autonomous AI Sales Agents that qualify, nurture, and close leads across voice and text. Zero latency. Zero missed opportunities. Scale your top performers infinitely." />
                <meta name="keywords" content="AI sales agents, autonomous sales AI, sales automation, lead qualification AI, sales chatbot, voice AI sales, conversational AI, sales productivity" />

                {/* Open Graph Tags */}
                <meta property="og:title" content="AI for Sales - Autonomous Sales Agents | Nexby" />
                <meta property="og:description" content="Deploy autonomous AI Sales Agents that qualify, nurture, and close leads. Scale infinitely with zero latency." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://nexby.ai/solutions/sales" />
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        ...
                        "itemListElement": [{
                            ...
                            "position": 3,
                            "name": "AI for Sales",
                            "item": "https://nexby.ai/solutions/sales"
                        }]
                    })}
                </script>
                ...
                <script type="application/ld+json">
                    {JSON.stringify({
                        "@context": "https://schema.org",
                        "@type": "Product",
                        "name": "Nexby AI Sales Agents",
                        "description": "Autonomous AI Sales Agents for lead qualification, nurturing, and closing",
                        "brand": {
                            "@type": "Brand",
                            "name": "Nexby"
                        },
            ...
            <div className="min-h-screen bg-white pt-20">
                ...
                <nav className="max-w-7xl mx-auto px-6 py-4" aria-label="Breadcrumb">
                    <ol className="flex items-center space-x-2 text-sm text-gray-600">
                        ...
                        <li className="before:content-['/'] before:mx-2 text-purple-600 font-medium">AI for Sales</li>
                    </ol>
                </nav>
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        <div className="max-w-4xl mx-auto text-center">
                            <div className="inline-flex items-center gap-2 bg-white/80 backdrop-blur-sm border-2 border-purple-300 rounded-full px-4 py-2 mb-6 shadow-lg">
                                ...
                                <span className="text-sm font-bold text-purple-900 uppercase tracking-wide">Solutions for Sales</span>
                            </div>

                            <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-6 leading-tight">
                                Your Top Performer.<br />
                            ...
                            <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
                                Deploy autonomous AI Sales Agents that qualify, nurture, and close leads across voice and text. <span className="font-bold text-purple-700">Zero latency. Zero missed opportunities.</span>
                            </p>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="flex flex-wrap justify-center items-center gap-8 md:gap-16">
                            ...
                            <div className="flex items-center gap-3 group cursor-default">
                                ...
                                <span className="font-semibold text-white text-lg">Phone Call</span>
                            </div>
                            ...
                            <div className="flex items-center gap-3 group cursor-default">
                                ...
                                <span className="font-semibold text-white text-lg">Website</span>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="max-w-5xl mx-auto px-6">
                        ...
                        <div className="prose prose-lg max-w-none">
                            <p className="text-lg text-gray-700 leading-relaxed mb-4">
                                <span className="font-bold text-purple-700">Speed is the currency of modern sales.</span> The average lead goes cold in 5 minutes. While your competitors are waiting for their SDRs to clock in, Nexby is already having a conversation.
                            </p>
                            <p className="text-lg text-gray-700 leading-relaxed">
                                We don't build basic "chatbots" that follow decision trees. We build <span className="font-bold bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Cognitive Sales Agents</span>—LLM-powered digital employees trained on your company's DNA, capable of handling complex negotiations with the nuance of a human and the speed of a machine.
                            </p>
                        </div>
                    </div>
                </section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-purple-200 hover:border-purple-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <p className="text-gray-600 mb-6">
                                    Forget "Press 1 for Sales." Our agents utilize dynamic LLM architectures to understand intent, context, and sentiment.
                                </p>
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        <Zap className="text-purple-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Dynamic Personality:</span>
                                            <span className="text-gray-600"> The agent adapts its tone to the user—professional for banking clients, empathetic for healthcare, or persuasive for retail.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Database className="text-purple-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Context Retention:</span>
                                            <span className="text-gray-600"> It remembers what was said 10 messages ago, ensuring a coherent, human-like dialogue.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <ul className="space-y-3">
                                    <li className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <span className="font-bold text-gray-900">Voice & Telephony:</span>
                                            <span className="text-gray-600"> Natural, conversational voice AI that handles inbound queries and outbound qualification calls.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <MessageCircle className="text-blue-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Text Ecosystem:</span>
                                            <span className="text-gray-600"> Seamless integration with WhatsApp, Facebook Messenger, Email, and Website Chat.</span>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <Zap className="text-blue-600 shrink-0 mt-1" size={18} />
                                        <div>
                                            <span className="font-bold text-gray-900">Unified Context:</span>
                                            <span className="text-gray-600"> A conversation started on WhatsApp can be finished over a voice call without missing a beat.</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div className="group bg-white rounded-3xl p-8 border-2 border-green-200 hover:border-green-400 shadow-lg hover:shadow-2xl transition-all transform hover:-translate-y-2">
                                ...
                                <p className="text-gray-600 mb-4">
                                    We ingest your sales playbooks, technical documentation, website data, and past call transcripts. The result is an agent that knows your product better than your newest hire—from Day 1.
                                </p>
                                <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                                    <p className="text-sm font-medium text-green-900">
                                        ✓ Your brand voice, your objection handling, your closing techniques—scaled infinitely.
                                    </p>
                                </div>
                            </div>
                        </div>
                ...
                <section className="py-20 bg-slate-900 text-white">
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <p className="text-lg text-gray-300 leading-relaxed mb-12 max-w-4xl mx-auto text-center">
                            We understand that for Government, Banking, and Defense, "Cloud" isn't always the answer. Nexby offers flexible deployment models designed for uncompromising security.
                        </p>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border-2 border-pink-500/30 rounded-2xl p-8 hover:bg-white/10 hover:border-pink-500/50 transition-all">
                                ...
                                <h3 className="text-xl font-bold mb-3">On-Premise / Air-Gapped</h3>
                                <p className="text-gray-300">
                                    For sensitive projects, we deploy the LLM directly within your private infrastructure. Your data never leaves your perimeter.
                                </p>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border-2 border-blue-500/30 rounded-2xl p-8 hover:bg-white/10 hover:border-blue-500/50 transition-all">
                                ...
                                <p className="text-gray-300">
                                    Built to adhere to strict data sovereignty and privacy standards.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-8 hover:bg-white/10 transition-all">
                                ...
                                <p className="text-sm text-purple-300 font-medium mb-4 uppercase tracking-wider">Lead Qualification & Revival</p>
                                <p className="text-gray-300 mb-6 leading-relaxed">
                                    We deployed AI agents to handle end-to-end lead qualification, including cold calling old databases.
                                </p>
                                <div className="bg-purple-500/10 rounded-lg p-4 border-l-4 border-purple-500">
                                    ...
                                    <p className="text-sm text-gray-400">
                                        Generated purely from reviving dormant leads in their old dataset.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-blue-500/30 rounded-2xl p-8 hover:bg-white/10 transition-all">
                                ...
                                <p className="text-sm text-blue-300 font-medium mb-4 uppercase tracking-wider">B2B Sales Enablement</p>
                                <p className="text-gray-300 mb-6 leading-relaxed">
                                    For a heavy equipment manufacturer, our agents engaged technical buyers to qualify intent before passing to sales engineers.
                                </p>
                                <div className="bg-blue-500/10 rounded-lg p-4 border-l-4 border-blue-500">
                                    ...
                                    <p className="text-sm text-gray-400">
                                        Sales team stopped chasing bad leads and focused only on high-intent buyers.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-white/5 backdrop-blur-sm border border-green-500/30 rounded-2xl p-8 hover:bg-white/10 transition-all">
                                ...
                                <p className="text-sm text-green-300 font-medium mb-4 uppercase tracking-wider">Emergency Response</p>
                                <p className="text-gray-300 mb-6 leading-relaxed">
                                    Built an emergency call center voice agent capable of understanding regional languages and accents in noisy environments.
                                </p>
                                <div className="bg-green-500/10 rounded-lg p-4 border-l-4 border-green-500">
                                    ...
                                    <p className="text-sm text-gray-400">
                                        Zero dropped calls. Critical info logged and instantly relayed to emergency teams.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                            ...
                            <div className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-3xl p-8 border-2 border-purple-200 hover:border-purple-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    Stop wasting senior AE time on tire-kickers. Nexby engages every inbound lead instantly, answers FAQs, handles objections, and books meetings only for qualified prospects.
                                </p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-3xl p-8 border-2 border-blue-200 hover:border-blue-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    Have a database of 10,000 cold leads? Nexby's Voice Bot can call them all in a single afternoon to re-engage interest, update details, and revive dormant opportunities.
                                </p>
                            </div>
                            ...
                            <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-3xl p-8 border-2 border-green-200 hover:border-green-400 hover:shadow-xl transition-all">
                                ...
                                <p className="text-gray-700 leading-relaxed">
                                    For global organizations, the sun never sets. Your AI agent handles support and sales inquiries across all time zones, ensuring you are making money while your HQ sleeps.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="max-w-6xl mx-auto px-6">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                                We will analyze your current lead flow and show you exactly where AI can increase conversion.
                            </p>
                        </div>
