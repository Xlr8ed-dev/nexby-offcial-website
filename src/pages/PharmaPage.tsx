...
const PHASES = [
  {
    ...
    description:
      "Institutional sales drive volume, but the paperwork is brutal. Assigning a Senior Regulatory Officer to read a 2,000-page government tender document is a waste of talent.",
    color: "blue",
    icon: FileText,
    points: [
      {
        title: "Instant BOQ Extraction",
        desc: "Extracts exact molecules, dosages, and quantities to Excel.",
      },
      {
        title: "Compliance Check",
        desc: "Highlights 'USFDA Only' or 'WHO-GMP' requirements.",
      },
      {
        title: "Price Intelligence",
        desc: "Suggests optimal bid price based on historical winners.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "Your Medical Representatives are expensive. They should be spending 100% of their time influencing doctors, not counting boxes at a stockist's counter.",
    color: "green",
    icon: Phone,
    points: [
      {
        title: "The Stock-Taking Agent",
        desc: "Calls 5,000 stockists/chemists automatically on the 25th.",
      },
      {
        title: "Smart Conversation",
        desc: '"Do you need a refill on Brand X or Brand Y?"',
      },
      {
        title: "ERP Integration",
        desc: "Orders punched directly; MRs visit only problem accounts.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "The Pharma supply chain is global. Your buyer in Brazil or your distributor in Germany operates on a different clock and in a different language.",
    color: "indigo",
    icon: Globe,
    points: [
      {
        title: "The 24/7 Export Desk",
        desc: "Replies instantly to COA requests at 2 AM IST.",
      },
      {
        title: "Polyglot Support",
        desc: "Validates batch numbers and emails COAs in Spanish/Portuguese.",
      },
      {
        title: "Vendor Compliance",
        desc: "Passes compliance checks while you sleep.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "You spend a fortune on your stall at CPHI or Arab Health. Don't rely on fishbowls for lead capture. Internet connectivity is unreliable.",
    color: "purple",
    icon: Presentation,
    points: [
      {
        title: "Offline-First Capture",
        desc: "Scan badges & cards without internet.",
      },
      {
        title: "Smart Tagging",
        desc: '"Contract Manufacturing" vs "Finished Dosage".',
      },
      {
        title: "Instant Compliance",
        desc: "Sends Product Dossier & EU-GMP certs via WhatsApp instantly.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "A bad hire in Quality Control can shut down a plant. A bad hire in Sales can burn a territory. Our Recruiter Agent is configured for Pharma nuances.",
    color: "orange",
    icon: UserCheck,
    points: [
      {
        title: "Regulatory Affairs (RA)",
        desc: "Vetting eCTD submissions & USFDA knowledge.",
      },
      {
        title: "Quality Control (QC)",
        desc: "Screening for HPLC, GC, and GLP proficiency.",
      },
      {
        title: "R&D Scientists",
        desc: "Reviewing publications & formulation expertise.",
      },
    ],
  ...
  },
  {
    ...
    description:
      "In Pharma, a missed license renewal or a delayed pharmacovigilance report is a disaster. Stay ahead of statutory deadlines.",
    color: "red",
    icon: ShieldCheck,
    points: [
      {
        title: "Statutory Management",
        desc: "Automated reminders for Drug Licenses & GMP audits.",
      },
      {
        title: "Task Tracker",
        desc: 'Assign "Prepare Dossier for Brazil" and track to closure.',
      },
      {
        title: "Auto-Escalation",
        desc: "Alerts senior management on delayed critical tasks.",
      },
    ],
...
const SUCCESS_STORIES = [
  {
    ...
    challenge:
      "Selling bulk drugs to Latin America. Language barriers delayed deals and response times were slow due to timezones.",
    solution:
      "Deployed Nexby's Multi-lingual AI Agent to handle initial inquiries in Spanish and Portuguese.",
    result: "30% faster deal closure cycle in LATAM markets.",
  },
  {
    title: "Surgical Consumables Giant",
    challenge:
      "Managing stock across 2,000 distributors nationwide. MRs were wasting days on low-value stock-taking calls.",
    solution:
      "Used Nexby's AI TeleCaller to automate primary order taking at month-end.",
    result:
      "MR productivity increased by 40% as they focused purely on hospital networking.",
  },
];
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="max-w-2xl">
                <div className="inline-flex items-center gap-2 bg-teal-500/10 backdrop-blur-sm border border-teal-400/20 rounded-full px-4 py-2 mb-6">
                  ...
                  <span className="text-sm font-bold text-teal-100 uppercase tracking-wide">
                    Industry Solutions
                  </span>
                </div>
                ...
                <p className="text-xl md:text-2xl text-gray-300 mb-8 leading-relaxed">
                  The world’s first AI Operating System for the Life Sciences
                  supply chain. From analyzing hospital tenders to automating
                  stockist calls and hiring QC experts.
                </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-slate-950/50 rounded-xl p-4 border border-white/5">
                      ...
                      <p className="text-xs text-slate-400 mb-2">
                        Extracting molecules & dosages from
                        'MoH_Tender_2025.pdf'...
                      </p>
                    ...
                    <div className="bg-slate-950/50 rounded-xl p-4 border border-white/5">
                      ...
                      <p className="text-xs text-slate-300 italic">
                        "Calling ABC Pharma Distributors... Order taken: 50
                        boxes of Para-500."
                      </p>
                    </div>
          ...
          <div className="max-w-4xl mx-auto px-6">
            <div className="bg-slate-50 rounded-3xl p-8 md:p-12 border border-slate-200 relative overflow-hidden">
              ...
              <div className="prose prose-lg text-slate-700 relative z-10">
                ...
                <p className="mb-6">
                  When I look at the Pharmaceutical industry, I see a
                  contradiction. In the R&D labs, you are using the most
                  advanced technology on earth. But in the sales office, I see
                  Medical Representatives (MRs) filling out manual daily
                  reports. I see Regulatory teams drowning in paper tenders. I
                  see Export Managers losing deals because of timezone delays.
                </p>
                <p className="mb-6">
                  I don't claim to know chemistry. But I know{" "}
                  <strong>Systems Engineering</strong>.
                </p>
                <p className="font-medium text-slate-900">
                  Nexby applies the rigorous logic of software architecture to
                  the chaotic reality of Pharma sales and operations. We
                  automate the 'busy work'—the stock-taking calls, the resume
                  screening, the tender reading—so your scientific talent can
                  focus on what they do best: saving lives and growing the
                  business.
                </p>
              </div>
          ...
          <div className="max-w-7xl mx-auto px-6 mb-10 flex justify-between items-end">
            <div>
              ...
              <p className="text-xl text-slate-600">
                From institutional tenders to global compliance.
              </p>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-slate-400">
                Real results from the lab to the market.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              {SUCCESS_STORIES.map((story, i) => (
                <div
                  key={i}
                  className="bg-slate-800 rounded-2xl p-8 border border-slate-700 hover:border-teal-500/50 transition-colors"
                >
          ...
          <div className="max-w-7xl mx-auto px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto mb-8">
                Let’s analyze your current Tender or Sales process. No sales
                pitch, just a process audit.
              </p>
              <a
                href="#"
                className="text-teal-600 font-bold underline hover:text-teal-700"
              >
                Download CPHI Lead Gen Case Study
              </a>
            </div>
