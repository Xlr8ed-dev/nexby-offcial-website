        ...
        <div className="max-w-2xl mx-auto px-6 py-20 text-center">
          ...
          <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200 mb-10">
            ...
            <p className="text-lg text-slate-700 leading-relaxed mb-4">
              "Thanks for sharing your volume metrics. Our efficiency team will
              analyze your potential deflection rate and will get back to you
              with a custom report within 24 hours."
            </p>
