...
const SupportAssistThankYouPage = () => {
    useEffect(() => {
        window.scrollTo(0, 0);
    }, []);
    ...
    return (
        <>
            <Helmet>
                <title>Thank You - Nexby Support Assist</title>
                <meta name="robots" content="noindex" />
            </Helmet>

            <div className="min-h-screen bg-white pt-20 flex items-center justify-center">
                <div className="max-w-2xl mx-auto px-6 py-20 text-center">
                    <div className="w-20 h-20 bg-blue-100 rounded-full flex items-center justify-center mx-auto mb-8 animate-in zoom-in duration-500">
                    ...
                    <div className="bg-slate-50 rounded-2xl p-8 border border-slate-200 mb-10">
                        ...
                        <p className="text-lg text-slate-700 leading-relaxed mb-4">
                            "Thanks for sharing your volume metrics. Our efficiency team will analyze your potential deflection rate and will get back to you with a custom report within 24 hours."
                        </p>
...
export default SupportAssistThankYouPage;
