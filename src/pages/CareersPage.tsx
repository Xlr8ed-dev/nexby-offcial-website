    ...
    return [
        {
            ...
            type: "Full-time",
            description: "Lead the development of our core autonomous agent technology. Experience with LLMs and Python required.",
        ...
        },
        {
            ...
            location: "Remote",
            type: "Full-time",
            description: "Build beautiful, responsive interfaces for our next-gen AI platforms using React and Tailwind.",
        ...
        },
        {
            ...
            type: "Full-time",
            description: "Drive enterprise adoption of Nexby's AI solutions across key sectors. 5+ years of SaaS sales experience.",
        ...
        },
        {
            ...
            location: "Remote",
            type: "Contract",
            description: "Shape the user experience of our AI tools. Strong portfolio in B2B SaaS required.",
            applyUrl: "#"
        }
    ];
};
    ...
    return (
        <>
            <Helmet>
                ...
                <meta name="description" content="Join Nexby and help us build the next generation of autonomous AI agents. We're looking for passionate problem solvers." />
            </Helmet>
            ...
            <div className="bg-white min-h-screen font-sans selection:bg-black selection:text-white">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        ...
                        >
                            ...
                            <h1 className="text-5xl md:text-7xl font-bold tracking-tight text-gray-900 mb-8 leading-tight">
                                Don't Just Write Code. <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Engineer Intelligence.</span>
                            </h1>
                            <p className="text-xl text-gray-600 leading-relaxed max-w-2xl mx-auto mb-8">
                                We are building the autonomous enterprise. If you want to build the engine rather than just turn the crank, you belong here.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                                <a href="#openings" className="px-8 py-3 bg-black text-white rounded-full font-medium hover:bg-gray-800 transition-all">
                                    View Open Roles
                                </a>
                        ...
                        <div className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6">
                            <div>
                                ...
                                <p className="text-gray-600 max-w-xl">
                                    When we aren't training models, we're crushing code reviews or crushing it at Counter-Strike.
                                </p>
                            </div>
                ...
                <div className="py-20 bg-black text-white relative overflow-hidden" id="openings">
                    ...
                    <div className="max-w-7xl mx-auto px-6 relative z-10">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-5xl font-bold mb-6">Join the Squad.</h2>
                        ...
                        <div className="mt-16 text-center">
                            <p className="text-gray-400">
                                Don't see what you're looking for? <a href="mailto:careers@nexby.ai" className="text-white underline hover:text-blue-400">Email us</a> your resume.
                            </p>
                        </div>
                    </div>
                </div>
