        ...
        <>
            ...
            <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-center">
                ...
                <p className="text-xl text-slate-600 max-w-2xl mb-12">
                    Our Pharma Operations team has received your details. We will reach out within 24 hours to schedule the initial discovery call.
                </p>
                ...
                <div className="bg-slate-50 p-8 rounded-2xl border border-slate-200 max-w-lg w-full mb-12">
                    ...
                    <ul className="text-left space-y-4 text-slate-600">
                        <li className="flex gap-3">
                            <span className="bg-cyan-100 text-cyan-800 font-bold w-6 h-6 flex items-center justify-center rounded-full text-xs">1</span>
                            <span>We will map your current process (Tender/Sales/QC).</span>
                        </li>
                        <li className="flex gap-3">
                            <span className="bg-cyan-100 text-cyan-800 font-bold w-6 h-6 flex items-center justify-center rounded-full text-xs">2</span>
                            <span>You will receive a <strong>Gap Analysis Report</strong>.</span>
                        </li>
                        <li className="flex gap-3">
                            <span className="bg-cyan-100 text-cyan-800 font-bold w-6 h-6 flex items-center justify-center rounded-full text-xs">3</span>
