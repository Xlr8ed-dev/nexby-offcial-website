            ...
            >
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-3 mt-1">
                  <button
                    ...
                    onClick={() =>
                      handleTagClick(
                        "Leads are high volume, but my team is too slow to follow up."
                      )
                    }
                    className="text-[10px] bg-gradient-to-r from-red-500/20 to-orange-500/20 hover:from-red-500/30 hover:to-orange-500/30 border border-red-400/50 text-red-200 rounded-full px-3 py-1.5 transition-all font-medium"
                  >
                    🔥 Leads getting cold
                  </button>
                  <button
                    ...
                    onClick={() =>
                      handleTagClick(
                        "Spending too much time filtering bad resumes."
                      )
                    }
                    className="text-[10px] bg-gradient-to-r from-blue-500/20 to-cyan-500/20 hover:from-blue-500/30 hover:to-cyan-500/30 border border-blue-400/50 text-blue-200 rounded-full px-3 py-1.5 transition-all font-medium"
                  >
                  ...
                  <button
                    ...
                    onClick={() =>
                      handleTagClick(
                        "Customer support costs are eating our margins."
                      )
                    }
                    className="text-[10px] bg-gradient-to-r from-green-500/20 to-emerald-500/20 hover:from-green-500/30 hover:to-emerald-500/30 border border-green-400/50 text-green-200 rounded-full px-3 py-1.5 transition-all font-medium"
                  >
                    💸 Support costs high
                  </button>
                </div>
              ...
              <div className="flex flex-col gap-2 rounded-2xl bg-black/40 px-4 py-3 text-xs text-slate-50 border border-purple-500/20">
                ...
                <p className="text-slate-300 leading-relaxed">
                  We are selective because we care about results, not volume. If
                  you are ready to move, you matter to us. You will hear from
                  our strategy team within 24 hours.
                </p>
              </div>
