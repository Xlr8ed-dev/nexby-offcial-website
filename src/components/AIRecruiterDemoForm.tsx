            ...
            <div className="max-w-4xl mx-auto px-6">
                <div className="text-center mb-12">
                    ...
                    <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                        Book a personalized demo of AI Recruiter. See how you can screen, interview, and rank talent at scale.
                    </p>
                </div>
                ...
                <div className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 rounded-3xl p-8 md:p-12 shadow-2xl border border-blue-500/20">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <ChevronDown className="absolute right-4 top-1/2 -translate-y-1/2 text-blue-300 pointer-events-none" size={18} />
                                </div>
                            </div>
                        </div>
                        ...
                        <div>
                            <label className="block text-sm font-semibold text-blue-100 mb-2">
                                Mobile Number <span className="text-blue-300 font-normal">(Optional)</span>
                            </label>
                                ...
                                {SOURCING_CHANNELS.map((channel) => (
                                    <label
                                        ...
                                        className={`
                                            ...
                                            ${formData.sourcingChannels.includes(channel)
                                                ? 'border-blue-500 bg-blue-500/20 text-white shadow-lg shadow-blue-500/20'
                                                : 'border-blue-400/20 bg-white/5 text-blue-200 hover:border-blue-400/40 hover:bg-white/10'}
                                        `}
                                    >
