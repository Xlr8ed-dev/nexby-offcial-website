...
const SupportAuditForm = ({
  formId = "support-audit",
}: SupportAuditFormProps) => {
  ...
  return (
    <div
      id="audit-form"
      className="bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 rounded-3xl p-8 md:p-12 shadow-2xl border border-blue-500/20"
    >
      <div className="mb-8">
        ...
        <p className="text-blue-200 text-lg">
          Tell us about your support volume. We'll show you exactly how many
          tickets we can deflect.
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-5">
            ...
            <div>
              <label className="text-sm font-semibold text-white mb-3 block">
                ...
                <span className="text-blue-400">{resolutionTime}h</span>
              </label>
              <input
                type="range"
                min="1"
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2 mb-3">
            ...
            <button
              type="button"
              onClick={() =>
                handleTagClick("Response times are too slow during peak hours.")
              }
            ...
            <button
              ...
              onClick={() =>
                handleTagClick(
                  "Agents give inconsistent answers or outdated info.",
                )
              }
            ...
            <button
              ...
              onClick={() =>
                handleTagClick(
                  "Support costs are scaling too fast with user growth.",
                )
              }
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <label
              className={`flex items-center gap-3 bg-white/5 backdrop-blur-sm border-2 rounded-xl p-4 cursor-pointer transition-all ${contactMethod === "email" ? "border-blue-400 bg-blue-500/10" : "border-blue-400/30 hover:bg-white/10 hover:border-blue-400/50"}`}
            >
              <input
                type="radio"
                name="contactMethod"
            ...
            <label
              className={`flex items-center gap-3 bg-white/5 backdrop-blur-sm border-2 rounded-xl p-4 cursor-pointer transition-all ${contactMethod === "phone" ? "border-blue-400 bg-blue-500/10" : "border-blue-400/30 hover:bg-white/10 hover:border-blue-400/50"}`}
            >
              <input
                type="radio"
                name="contactMethod"
            ...
            <label
              className={`flex items-center gap-3 bg-white/5 backdrop-blur-sm border-2 rounded-xl p-4 cursor-pointer transition-all ${contactMethod === "whatsapp" ? "border-blue-400 bg-blue-500/10" : "border-blue-400/30 hover:bg-white/10 hover:border-blue-400/50"}`}
            >
              <input
                type="radio"
                name="contactMethod"
        ...
        <div className="bg-gradient-to-r from-blue-500/10 to-indigo-500/10 border border-blue-400/30 rounded-2xl px-5 py-4">
          <p className="text-sm text-blue-100 leading-relaxed">
            <span className="font-bold text-white">Guaranteed Deflection:</span>{" "}
            Our team will analyze your volume and show you which 70% of tickets
