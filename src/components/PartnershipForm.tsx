                ...
                <AnimatePresence mode="wait">
                    {step === 1 && (
                        ...
                        >
                            <div className="text-center mb-8">
                                ...
                                <h4 className="text-2xl font-bold text-slate-900 mb-2">Let's start with the basics.</h4>
                                <p className="text-slate-600">Tell us about you and your organization.</p>
                            </div>
                    ...
                    {step === 2 && (
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="Government Prime / Liaison">Government Prime / Liaison</option>
                                        <option value="Recruitment / Staffing Agency">Recruitment / Staffing Agency</option>
                                        <option value="Digital Marketing Agency">Digital Marketing Agency</option>
                                        <option value="Event / Exhibition Organizer">Event / Exhibition Organizer</option>
                                        <option value="System Integrator / Consultant">System Integrator / Consultant</option>
                            ...
                            <button
                                onClick={handleNext}
                                disabled={!formData.region || !formData.partnerType || !formData.email || !formData.phone}
                        ...
                        >
                            ...
                            <div className="mb-8">
                                ...
                                <p className="text-xs text-slate-500 mt-2">
                                    Share your current client base, geographic presence, or specific use cases you'd like to address.
                                </p>
                            </div>

                            <div className="mt-6 bg-cyan-50 p-4 rounded-xl border border-cyan-100">
                                <p className="text-xs text-cyan-800 leading-relaxed">
                                    <strong>Privacy:</strong> Your partnership proposal and business information will be treated confidentially. We sign NDAs for all partnership discussions.
                                </p>
                            </div>
