                    ...
                    {step === 2 && (
                        ...
                        >
                            ...
                            <div className="space-y-4">
                                <div>
                                    <label className="block text-sm font-bold text-slate-700 mb-2">Primary Sector</label>
                                    <select
                                        name="sector"
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-sm font-bold text-slate-700 mb-2">Monthly RFPs</label>
                                        <select
                                            name="tenderVolume"
                                    ...
                                    <div>
                                        <label className="block text-sm font-bold text-slate-700 mb-2">Dealer Count</label>
                                        <select
                                            name="dealerCount"
                        ...
                        >
                            ...
                            <div className="mb-8">
                                ...
                                <div className="grid grid-cols-1 gap-3">
                                    {['Less than 1,000', '1,000 - 5,000', '5,000 - 10,000', '10,000+'].map((option) => (
                                        <label
                                            key={option}
                        ...
                        >
                            ...
                            <div className="mt-6 bg-blue-50 p-4 rounded-xl border border-blue-100">
                                <p className="text-xs text-blue-800 leading-relaxed">
                                    <strong>Disclaimer:</strong> We are allowing the opportunity to schedule this call on a good faith basis and request only genuine information.
                                </p>
                            </div>
