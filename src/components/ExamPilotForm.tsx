...
import { Send, Loader2, AlertCircle, Building2, Users, Mail } from 'lucide-react';
    ...
    return (
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-xl border border-gray-100 relative overflow-hidden">
            ...
            <div className="relative z-10">
                <div className="mb-8">
                    <h3 className="text-2xl font-bold text-gray-900 mb-2">Request Pilot Demo</h3>
                    <p className="text-gray-600">
                        Schedule a pilot exam for a single department. Experience the security firsthand.
                    </p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {['Paper', 'Online', 'Hybrid'].map((mode) => (
                                <button
                                    key={mode}
                                    type="button"
                                    onClick={() => setFormData({ ...formData, currentMode: mode })}
                                    className={`py-2 px-3 rounded-lg text-sm font-medium border transition-all ${formData.currentMode === mode
                    ...
                    <div>
                        <label htmlFor="email" className="block text-sm font-medium text-gray-700 mb-1">
                            Official Email (Registrar/VC Office) <span className="text-red-500">*</span>
                        </label>
                        <div className="relative">
                            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
