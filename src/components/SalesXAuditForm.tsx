            ...
            >
              <div className="text-center mb-8">
                ...
                <h4 className="text-2xl font-bold text-slate-900 mb-2">
                  Let's understand your scale.
                </h4>
                <p className="text-slate-600">
                  Help us size the AI infrastructure for your team.
                </p>
              </div>
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-sm font-bold text-slate-700 mb-3 flex items-center gap-2">
                    <Users size={16} className="text-blue-500" /> Size of Sales
                    Team?
                  </label>
            ...
            >
              ...
              <div className="mt-6 bg-blue-50 p-4 rounded-xl border border-blue-100">
                <p className="text-xs text-blue-800 leading-relaxed">
                  <strong>Ready to Scale?</strong> We will analyze your inputs
                  and propose a custom SalesX implementation plan.
                </p>
              </div>
