        ...
        <div className="w-full max-w-2xl mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden border border-slate-200">
            <div className="bg-slate-900 p-6 text-white border-b border-slate-800">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <h3 className="text-xl font-bold tracking-tight">Technical Proposal Request</h3>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="md:col-span-2">
                            <label className="block text-sm font-bold text-slate-700 mb-2">Ministry / Department / PSU</label>
                            <div className="relative">
                        ...
                        {/* Key Pain Point */}
                        <div className="md:col-span-2">
                            <label className="block text-sm font-bold text-slate-700 mb-2">Key Pain Point</label>
                            <div className="relative">
                                <HelpCircle className="absolute left-3 top-3.5 text-slate-400" size={18} />
                                <select
                                    name="keyPainPoint"
                                ...
                                >
                                    ...
                                    <option value="Historical Data Retrieval">Historical Data Retrieval</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-6 bg-blue-50 p-4 rounded-xl border border-blue-100 flex gap-3">
                        ...
                        <p className="text-xs text-blue-800 leading-relaxed">
                            <strong>Official Request:</strong> By submitting this form, you request a technical demonstration and case study. We may verify your credentials.
                        </p>
                    </div>
                    ...
                    >
                        {isSubmitting ? (
                            ...
                            <>
                                Request Technical Proposal & Case Study <CheckCircle size={20} />
                            </>
                        )}
                    </motion.button>
                </form>
