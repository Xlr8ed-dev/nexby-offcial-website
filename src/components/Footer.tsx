      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs leading-relaxed">
              Connect with us on social media for the latest updates on AI
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="text-gray-300 text-sm leading-relaxed">
              <h3 className="text-white font-bold text-lg mb-3">
                About Nexby AI Solutions
              </h3>
              <p className="mb-4">
                <strong className="text-white">Nexby AI Solutions</strong> is a
                leading enterprise AI automation company specializing in{" "}
                <strong className="text-indigo-400">
                  autonomous AI agents
                </strong>{" "}
                for sales, recruitment, and operations. We deploy
                production-grade AI systems that deliver measurable ROI across{" "}
                <strong className="text-indigo-400">
                  Real Estate, Manufacturing, Government, Technology, Banking,
                  Pharmaceuticals, and BPO sectors
                </strong>
                .
              </p>
              <p className="mb-4">
                Our flagship products—
                <strong className="text-indigo-400">AI Recruiter</strong>,{" "}
                <strong className="text-indigo-400">AI TeleCaller</strong>, and{" "}
                <strong className="text-indigo-400">Expo Insight</strong>
                —automate complex workflows with human-level nuance and
                machine-level speed. From screening thousands of candidates with
                military-grade proctoring to qualifying leads across voice and
                text channels, Nexby AI transforms business operations with{" "}
                <strong className="text-indigo-400">
                  90% time reduction
                </strong>{" "}
                and{" "}
              ...
              <p className="text-gray-400 text-xs">
                Trusted by 300+ businesses across India, GCC, and global
                markets. Average payback period: &lt; 6 months.
              </p>
            </div>
        ...
        <div className="pt-6 mt-6">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-gray-400">
            <p>
              © 2025 Nexby AI Solutions Private Limited. All rights reserved.
            </p>
